...
function phase2()
    ...
    if ((p1 == null) && (p2 == null) && (p3 == null))
        {       // first pass
        var _art = document.getElementsByTagName("article");
        if (_art.length > 0)    // found <article>
            {
            console.log ("<article> found");
            var _art1 = _art[0].getAttribute("data-vad");
            if (_art1 == "gr_vad")
                {
                console.log ("found data-vad tag in <article>");
...
// submit
        ...
        if (gr_version.length > 0)
            ...
            for (let i = 0; i < element.length; i++)
                ...
                console.log ("section version is ", _ver);
